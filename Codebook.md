The first few fields (1 - 3) are as follows:

act_descr = one of 6 activity descriptions:
...
subj_id = the id number for the subject gathering the data
act_id = the id corresponding to the act_descr describe above
